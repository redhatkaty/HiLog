 ...
 *
 */
public class GPSServiceShow2 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.show_gps_record);
		getViews();
		db = new GPSDatabase(this);
		List<String> list = db.listGPS();
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,R.layout.adapter_item_1,list);
